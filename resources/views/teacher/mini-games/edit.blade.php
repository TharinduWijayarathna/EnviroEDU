    ...
    <form method="POST" action="{{ route('teacher.mini-games.update', $miniGame) }}" id="mini-game-form" style="max-width: 700px;" enctype="multipart/form-data">
        ...
        <div style="margin-bottom: 1rem;">
            ...
            @if ($miniGame->gameTemplate->slug === 'environment_3d')
                <p style="font-size: 0.9rem; color: #555;">This game was generated by AI. You can change the title, description, and publish setting below. To change the questions, create a new game with a new prompt.</p>
            @endif
        </div>
        <div style="margin-bottom: 1rem;">
