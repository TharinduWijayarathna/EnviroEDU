...
class PlatformGameSeeder extends Seeder
{
    ...
    protected function games(): array
    {
        return [
            ...
            [
                'slug' => 'mosquito-lifecycle',
                'title' => 'Mosquito Life Cycle',
                'description' => 'See the four stages: egg, larva, pupa, and adult mosquito.',
                'order' => 6,
                'badge_name' => 'Life Cycle Explorer',
                'badge_slug' => 'badge-mosquito-lifecycle',
                'badge_icon' => '🦟',
                'badge_desc' => 'You learned the life cycle of a mosquito!',
            ],
            [
                'slug' => 'water-cycle',
